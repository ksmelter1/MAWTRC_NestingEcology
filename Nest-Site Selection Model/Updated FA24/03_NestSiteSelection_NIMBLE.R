...
colMeans(nimbleMCMC_samples[,219:233])
colSds(nimbleMCMC_samples[,219:233])

#' Extract the posterior samples for the 'beta' parameters (columns 219 to 230)
beta_samples <- nimbleMCMC_samples[, 219:233]
...
saveRDS(beta_samples, "01_NestModelSamples.RDS")
