...
#' Read in RDS files with data
#' samples_df <- column names, edited samples
#' Rename columns 
samples_df <- readRDS("Data Management/RData/Nest-Site Selection/ModelResults/02_NestModelSamples.RDS_1_10") 

#' Raw jags_samples from model for prediction plots
jags_samples <- readRDS("Data Management/RData/Nest-Site Selection/ModelResults/01_NestModelSamples.Raw.RDS_1_10")
