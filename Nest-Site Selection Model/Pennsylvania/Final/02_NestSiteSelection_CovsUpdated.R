...
#' Load in landcover
load("Data Management/RData/Nest-Site Selection/Covs/Multi-State/01_Covs_AllStates_Landcover.RData")
...
#' Convert land cover classifications to a categorical variable and create separate columns
nj.nests.covs$Agriculture <- ifelse(nj.nests.covs$landuse == "Agriculture", 1, 0)
...
#' Convert land cover classifications to a categorical variable and create separate columns
md.nests.covs$Agriculture <- ifelse(md.nests.covs$landuse == "Agriculture", 1, 0)
