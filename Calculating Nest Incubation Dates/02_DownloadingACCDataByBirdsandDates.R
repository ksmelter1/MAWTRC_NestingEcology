...
nests <- readRDS("Nest_data/Nesting_KJS/MD/20260109_NestingRanges_2025_NJ.rds")
head(nests$BandID)
...
# # Get unique list
# md_birds <- unique(as.character(daterange$BandID))
# bird_list_sql <- paste0("'", md_birds, "'", collapse = ",")
# 
# # Query to see if data exists from 2025 birds
# md_accel_range <- dbGetQuery(
#   conn,
#   paste0("
#     SELECT bandid,
#            MIN(date) AS min_dt,
...
# write.csv(
#   md_accel_range,
#   "D:/PA_TurkeyDataProcessing/Nest_data/Nesting_KJS/MD/MD_accelerometer_date_ranges.csv",
#   row.names = FALSE
# )
...
output_file_path <- "D:/PA_TurkeyDataProcessing/Nest_data/Nesting_KJS/NJ/20260109_nestingbirds_1_30_KJS.csv"
