...
#' Load NLCD Raster
nj.nlcd <- terra::rast("Data Management/Rasters/nlcd/nj.nlcd.tif")
plot(nj.nlcd)
...
primary <- terra::rast("Data Management/Rasters/PA Roads/NjRoadRast.Prim.tiff")

#' Distance to secondary roads Raster
secondary <- terra::rast("Data Management/Rasters/PA Roads/NjRoadRast.Sec.tiff")
