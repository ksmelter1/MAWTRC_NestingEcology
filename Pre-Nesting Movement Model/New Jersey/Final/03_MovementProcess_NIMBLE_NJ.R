...
load("Data Management/RData/Pre-Nesting Movement Model/New Jersey/Covariates/20250226_NJ_Ready.RData") 
rm(x)
...
#' Model parameters
#' No turkeys were in agriculture for draft 1 so I removed it from the model
X <- cbind(
...
new_names <- c("Intercept", "Distance to Primary Road", "Distance to Secondary Road", 
               "Mixed Forest", "Evergreen Forest", "Developed",
...
saveRDS(samples_df, "20250226_samples_df_NJ.RDS")
