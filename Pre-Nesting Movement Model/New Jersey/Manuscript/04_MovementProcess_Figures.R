...
samples_df <- readRDS("Data Management/RData/Pre-Nesting Movement Model/New Jersey/Covariates/Manuscript/20250515_samples_df_NJ_buffer.RDS")
...
save(p2.betas, mean_estimates3, file = "MAWTRC Nesting Ecology Manuscript/Figures/RData/Pre-Nesting Movement/pre.nj.betas.buffer.RData", overwrite = T)
