...
colMeans(nimbleMCMC_samples[, 3708:3715])
colSds(nimbleMCMC_samples[, 3708:3715])

# View traceplots
MCMCtrace(nimbleMCMC_samples[, 3708:3715], pdf = FALSE)

# Extract the posterior samples for the 'beta' parameters (columns 219 to 230)
beta_samples <- nimbleMCMC_samples[, 3708:3715]
...
samples_matrix <- as.matrix(nimbleMCMC_samples[, 3708:3715])
