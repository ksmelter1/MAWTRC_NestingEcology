...
primary <- terra::rast("Data Management/Rasters/Roads/New Jersey/NjRoadRast.Prim.tiff")

#' Distance to secondary roads Raster
secondary <- terra::rast("Data Management/Rasters/Roads/New Jersey/NjRoadRast.Sec.tiff")
