...
random_steps<- amt::random_steps(
  ...
  include_observed = T) %>%
  amt::extract_covariates(nj.nlcd, where ="end") %>%
...
# Remove NAs from landuse column 
...
# Output step data
# Saved here: Data Management/RData/Pre-Nesting Movement Model/New Jersey/Covariates/Manuscript/Covs_NJ_Buffer_Ready.RData
