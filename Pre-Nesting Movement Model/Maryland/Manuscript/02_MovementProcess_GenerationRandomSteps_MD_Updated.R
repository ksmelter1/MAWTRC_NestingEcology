...
# Remove steps with NAs in landuse column 
final_filtered_random_steps <- final_filtered_random_steps %>%
  dplyr::filter(landuse != is.na(landuse))
...
# Save used and available steps
# Saved here: Data Management/RData/Pre-Nesting Movement Model/Maryland/Covariates/Covs_Ready_Buffer_Updated.RData
