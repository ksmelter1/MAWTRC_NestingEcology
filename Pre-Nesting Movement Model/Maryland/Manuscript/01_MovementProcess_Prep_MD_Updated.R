...
# Read in Maryland incubation data and only include observations where nest incubation was detected
sample <- read_csv("Samples/Maryland/NestingSample_MD.updated.csv")
nests.inc <- right_join(nests.inc, sample)

# Coordinate issue with 1214
...
################################################################################
## Loop to Download Pre-Nesting GPS Data in Maryland
...
# Save GPS Data for SSF generation
# Saved here: Data Management/RData/Pre-Nesting Movement Model/Maryland/Covariates/Movebank_MD_Buffer.RData
