...
#' Read in nests csv
md.nests <- read_csv("Data Management/Csvs/Processed/Nests/Nests/20250219_CleanedNests_2022_2023_MD.csv")
md.nests
...
nests.inc <- read_csv("Data Management/Csvs/Processed/IncubationDates/20250131_NestAttempts_allbirds_MD.csv")
nests.inc
...
for (i in 1:nrow(md.nests1)) {
  ...
  md.nests1$enddate[i] <- startI - clutchsize 
