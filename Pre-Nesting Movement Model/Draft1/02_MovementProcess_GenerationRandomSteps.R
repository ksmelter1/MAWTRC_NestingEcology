...
DEM.proj <- terra::rast("Data Management/Rasters/DEM/paDEM.tiff") 
...
primary <- terra::rast("Data Management/Rasters/PA Roads/paroadrast.prim.tiff")

#' Distance to secondary roads Raster
secondary <- terra::rast("Data Management/Rasters/PA Roads/paroadrast.sec.tiff")
...
#' Save RData file for created random steps
#save(random_steps, stps, "Data Management/RData/Individual-Specific Movement Process/RData Files/02_RandomSteps_Prep.RData")
