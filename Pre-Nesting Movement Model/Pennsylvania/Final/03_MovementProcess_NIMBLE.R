...
load("Data Management/RData/Pre-Nesting Movement Model/Pennsylvania/Covariates/Draft4/20250301_CovsReady.RData") 
...
colMeans(nimbleMCMC_samples[, 43247:43255])
colSds(nimbleMCMC_samples[, 43247:43255])

#' View traceplots
#MCMCtrace(nimbleMCMC_samples, pdf = FALSE)

#' Extract the posterior samples for the 'beta' parameters (columns 219 to 230)
beta_samples <- nimbleMCMC_samples[, 43247:43255]
...
saveRDS(samples_df, "Data Management/RData/Pre-Nesting Movement Model/Pennsylvania/Model Results/20250301_samples_df.RDS")
