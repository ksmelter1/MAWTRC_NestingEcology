...
load("Data Management/RData/Pre-Nesting Movement Model/Pennsylvania/Covariates/Manuscript/Covs_Ready_Buffer_Updated.RData") 
rm(x)
...
colMeans(nimbleMCMC_samples[, 77434:77441])
colSds(nimbleMCMC_samples[, 77434:77441])

# View traceplots
MCMCtrace(nimbleMCMC_samples[, 77434:77441], pdf = F)

# Extract the posterior samples for the 'beta' parameters (columns 219 to 230)
beta_samples <- nimbleMCMC_samples[, 77434:77441]
...
samples_matrix <- as.matrix(nimbleMCMC_samples[, 77434:77441])
