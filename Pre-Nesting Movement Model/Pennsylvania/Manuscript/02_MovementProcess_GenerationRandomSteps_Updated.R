...
# Load GPS Data
load("Data Management/RData/Pre-Nesting Movement Model/Pennsylvania/Covariates/Final/Movebank_PA_Buffer.RData")
...
# 5. Use the map function to apply the same steps by burst parameters across the marked sample
