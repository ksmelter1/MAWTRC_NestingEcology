################################################################################
#'---
#' title: Nest Data Cleaning for New Jersey
#' author: "K. Smelter
...
#'---
#'  
#' **Purpose**: This script cleans New Jersey Nesting Data for Further Analysis
...
nests.sf <- nests.sf %>%
  dplyr::filter(NestID != "0281_2025_1") %>%
  dplyr::filter(NestID != "0373_2025_1") 
...
saveRDS(
  nests_cleaned_nj,
  "Data Management/Csvs/Processed/Nests/Nests/New Jersey//20260109_CleanedNests_2023_2024_2025_NJ.rds"
)

# Write csv
write.csv(nests_clean, "Data Management/Csvs/Processed/Nests/Nests/20260109_CleanedNests_2024_2025_NJ.csv")
