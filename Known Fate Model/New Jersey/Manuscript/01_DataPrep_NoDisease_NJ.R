...
nests <- read_csv("Data Management/Csvs/Processed/Incubation Dates/New Jersey/20250131_NestAttempts_allbirds_NJ.csv")
nests
...
nj.roads.prim <- terra::rast("Data Management/Rasters/Roads/New Jersey/NjRoadRast.Prim.tiff")
nj.roads.sec <- terra::rast("Data Management/Rasters/Roads/New Jersey/NjRoadRast.Sec.tiff")
...
hens.behav.out <- readRDS("Data Management/Csvs/Processed/Covariates/New Jersey/Behavior/Behavior.NJ.RDS")
hens.behav.out
...
write_csv(nj.sample, "Samples/New Jersey/NestingSample_NJ.csv")
...
print(weather.array.copy[12,,2])  # Tmin for both 2023 and 20245print(weather.array[102,,2])  # Precipitation for both 2023 and 2024
