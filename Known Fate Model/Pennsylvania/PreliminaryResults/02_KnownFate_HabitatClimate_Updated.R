...
weather.array <- readRDS("weather.RDS")
...
temperatureC2022 <- weather.array[1:169,1:365,1]
temperatureC2023 <- weather.array[1:169,366:730,1]
precip2022 <- weather.array[1:169,1:365,2]
precip2023 <- weather.array[1:169,366:730,2]

testTempC3Roll = data.frame(matrix(NA, nrow = 169, ncol = 151))   
testPrecip3Roll = data.frame(matrix(NA, nrow = 169, ncol = 151))
for(i in 1:nrow(surv.caps)){
  if(surv.caps$Year[i] == 1){
...
saveRDS(weather.array2, "weather.pa_2022_2023_3daymean.RDS")
weather.array2 <-readRDS("weather.pa_2022_2023_3daymean.RDS")
...
cor(nests.ready$IncubationConstancy, nests.ready$sum_sl)
#' Constants
Consts <- list(
...
beta_samples <- nimbleMCMC_samples[, 1:18]
