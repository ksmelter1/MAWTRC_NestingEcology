...
load("Data Management/RData/Known Fate/Maryland/Manuscript/Habitat_Weather/01_Covs_Ready.RData")
...
save(p2.betas, samples_df, mean_estimates, file = "MAWTRC Nesting Ecology Manuscript/Figures/RData/Known Fate/kf.betas.habitat.MD.RData")
