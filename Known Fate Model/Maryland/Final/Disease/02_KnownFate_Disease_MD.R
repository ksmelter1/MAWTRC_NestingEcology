...
load("Data Management/RData/Known Fate/Maryland/20250219_PreliminaryResults_Disease.RData")
...
md.sample <- read_csv("Samples/Maryland/NestingSample_MD.csv")
...
#' str(weather.array)
#' weather.array[1:104,1:730,1] <- as.matrix(tmin)
#' weather.array[1:104,1:730,2] <- as.matrix(precip)
#' weather.array[,,1]
#' 
#' #' Check
...
#' #' 4-19 to 9-16
#' temperatureC2023 <- weather.array[1:104,105:195,1]
#' temperatureC2024 <- weather.array[1:104,(105+366):(195+366),1]
#' precip2023 <- weather.array[1:104,105:195,2]
#' precip2024 <- weather.array[1:104,(105+366):(195+366),2]
#' 
#' testTempC = data.frame(matrix(NA, nrow = 104, ncol = 90))   
#' testPrecip = data.frame(matrix(NA, nrow = 104, ncol = 90))
...
save(p2.betas,
     mean_estimates1, 
     samples_df,
     file = "MAWTRC Nesting Ecology Manuscript/Figures/RData/Known Fate/p2.betas.disease.MD.RData",
     overwrite = T)
